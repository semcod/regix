...
- refactor: extract config from_dict into section parsers (CC 44→8), fix cache lookup bug
- feat(build): add configuration management system
- docs: update TODO.md with full audit results
- docs: add docstrings to VallmBackend and other backend classes
- chore: add tox.ini for multi-python testing
- chore: add bump_version stage before publish
- fix: add JSON coverage report to pytest addopts for pyqual
- chore: bump version to 0.1.11 [skip ci]
- chore: pyqual auto-fix iterations (multiple commits)
